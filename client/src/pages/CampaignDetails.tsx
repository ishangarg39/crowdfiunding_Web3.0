...
const CampaignDetails = (props: Props) => {
    ...
    <div>{isLoading && <Loader/>}
      ...
      <div className='mt-[60px] flex lg:flex-row flex-col gap-5'>
        <div className='flex-[2] flex flex-col gap-[40px]'>
          <div>
          <h4 className='font-epilogue font-bold text-[30px] text-white p-3 uppercase'>Creator</h4>
          <div className='mt-[20px] flex flex-row items-center flex-wrap gap-[14px]'>
            <div className='w-[52px] h-[52px] flex items-center justify-center rounded-full bg-[#2c2f32] cursor-pointer'>
              <img src={thirdweb} alt="ThirdWeb User" className='w-[60%] object-contain'></img>
            </div>
          </div>
          <div>
        ...
        <div>
          <h4 className='font-epilogue font-bold text-[30px] text-white  uppercase'>Story</h4>
          <div className='mt-[20px]'>
            <p className='mt-[4px] font-epilogue font-normal text-[16px] leading-[26px] text-justify text-[#808191]'>{state.description}
            </p>
          </div>
        </div>

        <div>
          <h4 className='font-epilogue font-bold text-[30px] text-white  uppercase'>Donators</h4>
          <div className='mt-[20px] flex flex-col gap-4'>{donators.length > 0 ? donators.map((item: any, index: number) => (
  ...
  <p className="mt-[4px] font-epilogue font-normal text-[16px] leading-[26px] text-justify text-[#808191]">
    No Donators Yet
        ...
        <h4 className='font-epilogue font-bold text-[30px] text-white  uppercase'>Fund</h4>
        ...
        <div className='mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]'>
          ...
          <div className='mt-[30px]'>
            ...
            <div className='my-[20px] p-4 bg-[#13131a] rounded-[10px]'>
              <h4 className='font-epilogue font-semiboold text-[14px] leading-[22px] text-white'>Back it because you believe in it.</h4>
